...
parser = argparse.ArgumentParser(description='PyTorch MetaQNN VCAE')
...
parser.add_argument('-dc', '--discriminator-classes', default=1, type=int,
                    metavar='DC', help='no. of output classes of discriminator')
...
parser.add_argument('-iu', '--init-utility', default=0.0, type=float,
                    metavar='IU', help='initial utility of all transitions. set to 0.0 for greedy update\
                     (default: 0.0)')
...
parser.add_argument('--layer-max-limit', default=6, type=int,
                    help='Maximum amount of conv layers in model (default: 6)')
parser.add_argument('--layer-min-limit', default=2, type=int,
                    help='Minimum amount of conv layers in model (default: 2)')
parser.add_argument('--max-fc', default=0, type=int,
                    help='maximum amount of hidden fully-connected layers (default: 0)')